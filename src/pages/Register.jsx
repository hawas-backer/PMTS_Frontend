...
const Register = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:8080/api/auth/check-email', { email });
      if (res.data.allowed) {
        const otpRes = await axios.post('http://localhost:8080/api/auth/send-registration-otp', { email });
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('http://localhost:8080/api/auth/verify-and-set-password', {
        email,
        otp,
        password,
        otpToken,
